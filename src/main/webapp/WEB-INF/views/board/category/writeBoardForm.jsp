				...
				<form name="tx_editor_form" id="tx_editor_form" method="post" enctype="multipart/form-data">
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>${loginSession.userId}
								<input style="width:100%; border:0;" type="hidden" id="userId" name="userId" value="${loginSession.userId}" /></td>
						</tr>
						<tr>
							<th style="width:20%"> 제목</th>
							<td><input style="width:100%; border:0;" type="text" id="bTitle" name="bTitle" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input style="width:200px; text-align: right; " type="text" id="value" name="value" placeholder="숫자로 입력" /> 원</td>
						</tr>
						<!-- <tr>
					...
					<table align="center"><tr>
						<td>
							...
							<input type="button" id="save" value="글쓰기" onclick="insertBoard(); return false;"/>
