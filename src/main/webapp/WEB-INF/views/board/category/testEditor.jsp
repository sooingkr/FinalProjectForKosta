...
<head>
   ...
   <link rel="stylesheet" href="/resources/daumEditor/css/editor.css" type="text/css"></link>
...
<body>
   ...
   <form name="tx_editor_form" id="tx_editor_form" action="/insert.jsp" method="post" enctype="multipart/form-data"> 
      <table width="100%">
         <tr> 
            <td>제목</td> 
